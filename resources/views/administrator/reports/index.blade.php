...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('admin.reports.yield-per-room') }}" method="post" class="form-group">
            @csrf
            ...
            <div class="form-row">
                ...
                <div class="col-md-2">
                    <label for="">&nbsp;</label>
                    <button class="btn btn-primary form-control" disabled>Pesquisar</button>
                </div>
            </div>            
        </form>
