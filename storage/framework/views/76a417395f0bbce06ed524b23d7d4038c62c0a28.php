...
<div class="container">
    <div class="row">
      <div class="col-md-12">
        <img src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="" class="center-image">
      </div>
    </div>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?php echo e(asset('images/salas/sala_01.webp')); ?>" class="d-block w-100" alt="...">
              </div>
      ...
      <div class="col-md-6">
        <div class="card">
          <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?php echo e(asset('images/salas/sala_02.webp')); ?>" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="<?php echo e(asset('images/salas/sala_02.webp')); ?>" class="d-block w-100" alt="...">
              </div>
...
<footer class="text-center text-lg-start bg-light text-muted">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i><?php echo e(env('APP_NAME')); ?>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © <?php echo e(\Carbon\Carbon::now()->format('Y')); ?> Copyright:
    <a class="text-reset fw-bold" href="#"><?php echo e(env('APP_NAME')); ?></a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\espaco_juntos\resources\views/inicio.blade.php ENDPATH**/ ?>