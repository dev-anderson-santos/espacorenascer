    ...
    <div class="<?php echo e($auth_type ?? 'login'); ?>-box">
        ...
        <div class="<?php echo e($auth_type ?? 'login'); ?>-logo">
            ...
            <a href="<?php echo e($dashboard_url); ?>">
                <img src="<?php echo e(asset(config('adminlte.logo_img'))); ?>" style="width: -webkit-fill-available;">
        ...
        <div class="card <?php echo e(config('adminlte.classes_auth_card', 'card-outline card-primary')); ?>">
            ...
            <?php if (! empty(trim($__env->yieldContent('auth_footer')))): ?>
                <div class="card-footer <?php echo e(config('adminlte.classes_auth_footer', '')); ?>" style="text-align: center;">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\espaco_juntos\resources\views/vendor/adminlte/auth/auth-page.blade.php ENDPATH**/ ?>