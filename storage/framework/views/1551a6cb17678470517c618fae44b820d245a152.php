...
<head>
    ...
    <?php if(!config('adminlte.enabled_laravel_mix')): ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('sweet-alert-2/sweetalert2.min.css')); ?>">
...
<body class="<?php echo $__env->yieldContent('classes_body'); ?>" <?php echo $__env->yieldContent('body_data'); ?>>
    ...
    <?php echo $__env->make('layouts.modalGlobal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(!config('adminlte.enabled_laravel_mix')): ?>
        ...
        <script src="<?php echo e(asset('sweet-alert-2/sweetalert2.all.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/bootbox.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/jquery.mask.js').'?'.time()); ?>" ></script>
        <script src="<?php echo e(asset('js/jquery.alphanumeric.js').'?'.time()); ?>" ></script>
        <script src="<?php echo e(asset('js/funcoes-gerais/masks.js').'?'.time()); ?>" ></script>
        <script src="<?php echo e(asset('js/funcoes-gerais/modal-global.js').'?'.time()); ?>" ></script>
        <script src="<?php echo e(asset('js/funcoes-gerais/index.js')); ?>"></script>
        <script src="<?php echo e(asset('js/schedule/index.js')); ?>"></script>
...
<?php /**PATH C:\wamp64\www\espaco_juntos\resources\views/vendor/adminlte/master.blade.php ENDPATH**/ ?>